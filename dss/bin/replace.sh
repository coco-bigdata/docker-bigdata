...
function setCurrentRoot(){
  ...
  sed -i  s#DSS_INSTALL_HOME=.*#DSS_INSTALL_HOME=${LINKIS_DSS_HOME}/dss#g ${ONE_CONGIN_PATH}
  sed -i  s#LINKIS_HOME=.*#LINKIS_HOME=${LINKIS_DSS_HOME}/linkis#g ${ONE_CONGIN_PATH}

  LINKIS_HOME=${LINKIS_DSS_HOME}/linkis
...
function linkisReplace(){
  ...
  LINKIS_CONGIN_PATH=${TMP_LINKIS_FILE_PATH}/config/linkis-env.sh
  LINKIS_DB_PATH=${TMP_LINKIS_FILE_PATH}/config/db.sh
  ...
  sed -i  s#HIVE_META_URL=.*#HIVE_META_URL=${HIVE_META_URL}#g ${LINKIS_CONGIN_PATH}
  sed -i  s#HIVE_META_USER=.*#HIVE_META_USER=${HIVE_META_USER}#g ${LINKIS_CONGIN_PATH}
  sed -i  s#HIVE_META_PASSWORD=.*#HIVE_META_PASSWORD=${HIVE_META_PASSWORD}#g ${LINKIS_CONGIN_PATH}
